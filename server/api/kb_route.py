...
kb_router.post(
    "/search_docs", response_model=List[dict], summary="Search Knowledge Base"
)(search_docs)
...
kb_router.post(
    "/delete_docs",
    response_model=BaseResponse,
    summary="Delete Files in Knowledge Base",
)(delete_docs)

# New Endpoint for deleting docs by ID
kb_router.post(
    "/delete_docs_by_id", response_model=BaseResponse, summary="Delete documents by ID"
)(delete_docs_by_id)
...
kb_router.post(
    "/update_info",
    response_model=BaseResponse,
    summary="Update Knowledge Base Description",
)(update_info)

kb_router.post(
    "/update_docs",
    response_model=BaseResponse,
    summary="Update Existing Files in Knowledge Base",
)(update_docs)
