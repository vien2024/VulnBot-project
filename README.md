...
### **4. Cấu hình kali linux**

Tải ssh trong kali linux 

Tải tool bằng file installer.sh

Hiệu chỉnh lại ip, username, password kali trong file basic_config.yaml
